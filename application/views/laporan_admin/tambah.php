			...
			<div class="row">
                <div class="col-md-6 col-sm-16">
					<div class="x_panel">
						...
						<div class="x_content">
						<br />
						<form class="form-horizontal form-label-left" enctype="multipart/form-data" action="<?php echo site_url('laporan_admin/tambah');?>" method="post">
									...
									<div class="col-md-9 col-sm-9 ">
										...
										<div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<div class="radio">
													<label>
														<input type="radio" class="flat" checked="" id="optionsRadios1" name="status" value="Proses" <?php echo set_radio('status', 'Proses', true); ?> > Proses
													</label>
												</div>
												<!-- <div class="radio">
													<label>

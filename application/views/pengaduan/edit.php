			...
			<div class="row">
                <div class="col-md-6 col-sm-16">
					<div class="x_panel">
						...
						<div class="x_content">
						<br />
						<form class="form-horizontal form-label-left" action="<?php echo site_url('pengaduan/update_pengaduan');?>" method="post">
	...
	<script type="text/javascript">
		$(document).ready(function(){
            ...
            function get_data_edit(){
            	...
            	$.ajax({
            		url : "<?php echo site_url('pengaduan/get_data_edit');?>",
                    method : "POST",

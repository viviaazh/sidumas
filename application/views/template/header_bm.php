        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"></i> <span>SIDUMAS</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="images/log-PU.png" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?= base_url(); ?>home_bm"><i class="fa fa-home"></i> Home </a>
                    
                  </li>
                  <li><a href="<?= base_url(); ?>pengaduan_bm/index/"><i class="fa fa-edit"></i> Pengaduan </a>
                   
                  </li>
                  <li><a href="<?= base_url(); ?>bina_marga/laporan_bm/index/"><i class="fa fa-book"></i> Laporan </a>

			...
			<div class="row">
                <div class="col-md-6 col-sm-16">
					<div class="x_panel">
						...
						<div class="x_content">
						<br />
						<form class="form-horizontal form-label-left" action="<?php echo site_url('pengaduan_kd/update_pengaduan');?>" method="post">
                        ...
                        <?php endforeach;?>
										...
										<div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<div class="radio">
													<label>
														<input type="radio" class="flat" checked="" id="optionsRadios1" name="status" value="Pengaduan diteruskan ke bina marga" <?php echo set_radio('status', 'Pengaduan diteruskan ke bina marga', true); ?> > Pengaduan diteruskan ke bina marga
													</label>
												</div>
												<div class="radio">
													<label>
														<input type="radio" class="flat" id="optionsRadios2" name="status" value="Perbaikan selesai" <?php echo set_radio('status', 'Perbaikan selesai'); ?> > Perbaikan selesai
													</label>
												</div>
											</div>
										</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.kecamatan').change(function(){ 
                ...
                $.ajax({
                    url : "<?php echo site_url('pengaduan_kd/get_desa');?>",
                    method : "POST",
                    data : {id: id},
                    async : true,
                    dataType : 'json',
            ...
            function get_data_edit(){
            	...
            	$.ajax({
            		url : "<?php echo site_url('pengaduan_kd/get_data_edit');?>",
                    method : "POST",

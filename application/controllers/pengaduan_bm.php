...
class pengaduan_bm extends CI_Controller {
    ...
    function index(){
        ...
        $this->load->view('bina_marga/pengaduan/index', $data);
    ...
    public function detail($id_pengaduan){
        ...
        $this->load->view('bina_marga/pengaduan/detail', $data);
        $this->load->view('template/footer_admin');
    }
    ...
    function get_edit(){
        ...
        $this->load->view('template/header_bm', $data);
        $this->load->view('bina_marga/pengaduan/edit',$data);
        $this->load->view('template/footer_admin');
    }
